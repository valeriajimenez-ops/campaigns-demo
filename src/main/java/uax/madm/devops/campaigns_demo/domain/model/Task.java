package uax.madm.devops.campaigns_demo.domain.model;
...
public class Task {
    ...
    public String toString() {
        return "Task [id=" + id + ", name=" + name + ", description=" + description + ", dueDate=" + dueDate + ", status=" + status + ", campaign=" + campaign + ", assignee=" + assignee + ", estimatedHours=" + estimatedHours + "]";
    }
