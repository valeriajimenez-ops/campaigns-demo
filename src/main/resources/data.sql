...
INSERT INTO Task(id, uuid, name, due_date, description, campaign_id, status, assignee_id, estimated_hours) VALUES (default, uuid(), 'Task 1', '2030-01-12', 'Task 1 Description', 1, 0, 2, 0);
INSERT INTO Task(id, uuid, name, due_date, description, campaign_id, status, assignee_id, estimated_hours) VALUES (default, uuid(), 'Task 2', '2030-02-10', 'Task 2 Description', 1, 0, 1, 0);
INSERT INTO Task(id, uuid, name, due_date, description, campaign_id, status, assignee_id, estimated_hours) VALUES (default, uuid(), 'Task 3', '2030-03-16', 'Task 3 Description', 1, 0, 2, 0);
